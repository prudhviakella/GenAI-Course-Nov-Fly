...
class PipelineConfig:
    ...
    # Semantic chunk sizes (chars) used by comprehensive_chunker
    CHUNK_TARGET_SIZE: int = 1500
    CHUNK_MIN_SIZE: int = 800
    CHUNK_MAX_SIZE: int = 3000         # raised from 2500 to match comprehensive_chunker default
    CHUNK_MAX_TABLE_SIZE: int = 2000   # tables larger than this become standalone chunks
