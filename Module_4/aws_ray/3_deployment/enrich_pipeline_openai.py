...
def run_pipeline(
    ...
    **kwargs,
    ...
    data = read_json_robust(str(input_path))
    ...
    # write_json_utf8 uses encoding='utf-8' + ensure_ascii=False —
    # prevents non-UTF-8 bytes from surviving into downstream JSON files.
    # stats embedded directly in output file for full auditability.
    write_json_utf8(str(output_path), {'chunks': enriched_chunks, 'stats': STATS})
